...
import type { LocationType } from "@openstad-headless/leaflet-map/src/types/location.js";
...
const ResourceOverviewMap = ({
	...
	const categorizeByField = categorize?.categorizeByField;
	...
	const showOnOffButtons =
		props?.resourceOverviewMapWidget?.enableOnOffSwitching || false;
