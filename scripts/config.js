...
async function setupEnvVars() {
	...
	const AUTH_FIRST_CLIENT_ID = (process.env.AUTH_FIRST_CLIENT_ID =
		process.env.AUTH_FIRST_CLIENT_ID || generateRandomToken({ length: 64 }));
	const AUTH_FIRST_CLIENT_SECRET = (process.env.AUTH_FIRST_CLIENT_SECRET =
		process.env.AUTH_FIRST_CLIENT_SECRET ||
		generateRandomToken({ length: 64 }));

	const IMAGE_PORT_API = (process.env.IMAGE_PORT_API =
	...
	const IMAGE_PORT_IMAGE_SERVER = (process.env.IMAGE_PORT_IMAGE_SERVER =
		process.env.IMAGE_PORT_IMAGE_SERVER || IMAGE_PORT_API + 1);
	const IMAGE_VERIFICATION_TOKEN = (process.env.IMAGE_VERIFICATION_TOKEN =
	...
	const CMS_DEFAULT_SETTINGS = (process.env.CMS_DEFAULT_SETTINGS =
