...
describe("authorizationCodes", () => {
	...
	describe("#find", () => {
		test("should return empty authorization tokens with invalid token request", () =>
			authorizationCodes
				.find("abc")
		...
		test("should find a token saved", () => {
			...
			return authorizationCodes
				.save(token, "1", "http://google.com", "1", "*")
	...
	describe("#save", () => {
		test("should save an authorization token correctly and return that token", () => {
			const token = utils.createToken();
			return authorizationCodes
				.save(token, "1", "http://google.com", "1", "*")
				.then((saved) =>
	...
	describe("#removeAll", () => {
		test("should remove all tokens", () => {
			...
			return authorizationCodes
				.save(token1, "1", "http://google.com", "1", "*")
				.then(() =>
					authorizationCodes.save(token2, "2", "http://google.com", "2", "*"),
				)
