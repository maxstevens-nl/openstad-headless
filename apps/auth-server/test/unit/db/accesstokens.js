...
describe("accesstokens", () => {
	...
	describe("#find", () => {
		test("should return empty access tokens with invalid token request", () =>
			accessTokens.find("abc").then((token) => expect(token).toBeUndefined));

		test("should return empty access tokens with null", () =>
			accessTokens.find(null).then((token) => expect(token).toBeUndefined));
	...
	describe("#delete", () => {
		test("should return empty access tokens with invalid token request", () =>
			accessTokens.delete("abc").then((token) => expect(token).toBeUndefined));

		test("should return empty access tokens with null", () =>
			accessTokens.delete(null).then((token) => expect(token).toBeUndefined));
