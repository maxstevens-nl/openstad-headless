				...
				<div className="container py-6">
					<Tabs defaultValue="general">
						<TabsList className="w-full bg-white border-b-0 mb-4 rounded-md">
							...
							<TabsTrigger value="notification">Notificatie opties</TabsTrigger>
									...
									>
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													<FormLabel>
														Nieuwe inzendingen van resources met deze tag moeten
														worden bevestigd via een ander e-mailadres
													</FormLabel>
													{YesNoSelect(field, {})}
													<FormMessage />
												</FormItem>
